    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					...
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="#"><?php echo $r_gal[1] ?></a>(<?php echo $r_gal[3] ?>)</h3>
    						<div class="d-flex">
    							<div class="pricing">
    						...
    						<div class="bottom-area d-flex px-3">
	    						<div class="m-auto d-flex">
                                                            <a href="pro_dt.php?mid=<?php echo $r_gal[0] ?>" class="add-to-cart d-flex justify-content-center align-items-center text-center">
