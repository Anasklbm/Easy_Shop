...
<?php
                    ...
                    if(isset($_POST['sub1']))
 {
    ...
    $ins=mysqli_query($dbcon,"insert into user_data values('','$t1','$t2','$t3','$t4','$t5','$t6','$t7','$nfn','0')");
    ...
    <div class="container">
        ...
        <div class="col-md-6">
            <form method="post"enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <input type="text" required="" class="form-control" name="t2" placeholder="Email">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <input type="text" required="" class="form-control" name="t5" placeholder="Contact Number">
                </div>
                <div class="form-group">
