...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <section class="ftco-section ftco-cart">
    			...
    			<div class="col-md-12 ftco-animate">
    				<div class="cart-list">
                                    <?php
                                                        ...
                                                        $sel_gal=mysqli_query($dbcon,"select * from p_order where sid='$usr' ");
        ...
        {
            ?>
                                                            <a href="as_del.php?mid=<?php echo $r_gal[0]  ?>"> <i><img style="width: 45px;height: 40px" src="../gif/WaitCover.gif"><font style="font-size: large" color='orange'></font></i></a>
            <?php
        }
 else {
        ...
        ?>
                                ...
                                <i><img style="width: 45px;height: 40px" src="../gif/checkmark.gif"><font style="font-size: large" color='orange'></i>
