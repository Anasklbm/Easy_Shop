...
<?php
                    ...
                    if(isset($_POST['sub1']))
 {
    ...
    $ins=mysqli_query($dbcon,"insert into del values('','$t1','$t2','$t3','$t4','$usr','1')");
    
    if($ins>0)
    {
      $ins1=mysqli_query($dbcon,"insert into user_log values('','$t3','$t4','del','1')");
        if($ins1>0)
        {
                header("location:add_del.php?suss=1");
            }
    }
                    ...
                    <div class="form-example-wrap">
                        ...
                        <div class="form-example-int">
                            <div class="form-group">
                                <label>Contact</label>
                                <div class="nk-int-st">
                                    <input type="text" required="" name="t2" class="form-control input-sm">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-example-int">
                            <div class="form-group">
                                <label>Email</label>
                                <div class="nk-int-st">
                                    <input type="text" required="" name="t3" class="form-control input-sm">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-example-int">
                            <div class="form-group">
                                ...
                                <div class="nk-int-st">
                                    <input type="password" name="t4" class="form-control input-sm">
                                </div>
                            </div>
                        </div>
