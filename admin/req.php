...
if(isset($_GET['upd']))
{
    ...
    if($upd2>0)
    {
        ...
        $ins3=mysqli_query($dbcon,"insert into chair values('','$uid','10','0')");
        if($ins3>0)
        {
                            ...
                            if(isset($_GET['del']))
{
    ...
    $uid=$_GET['uid'];  
    $upd=$_GET['del'];
    $upd1=mysqli_query($dbcon,"update shop_reg set st='2'where id='$upd'");
...
<html lang="en">
  <head>
    <title>Vegefoods - Free Bootstrap 4 Template by Trinity Technologies</title>
    <meta charset="utf-8">
  ...
  <body class="goto-here">
          ...
          <div class="col-lg-12 ftco-animate">
						<div class="row">
                                                     ...
                                                     <?php
                                                        ...
                                                        $sel_gal=mysqli_query($dbcon,"select * from shop_reg where st='0'");
		            ...
		            <div class="blog-entry align-self-stretch d-md-flex">
		              ...
		              <div class="text d-block pl-md-4">
		              	<div class="meta mb-3">
		                  <div><a href="#">(<?php
                                  $cat=mysqli_query($dbcon,"select * from s_cate where id='$r_gal[2]'");
                                  ...
                                  echo"$cat1[1]";
                                          ...
                                          ?>)</a></div>
                                    <div><a href="#"><b><?php echo $r_gal[11] ?></b></a></div>
		                 
		                </div>
		                <h3 class="heading"><?php echo $r_gal[1] ?><a href="#"></a></h3>
		                <p><?php echo $r_gal[5] ?></p>
                                <p><a href="req.php?upd=<?php echo $r_gal[0] ?>&uid=<?php echo $r_gal[3] ?>" class="btn btn-primary py-2 px-3">Approve</a>&nbsp;&nbsp;<a href="req.php?del=<?php echo $r_gal[0] ?>&uid=<?php echo $r_gal[3] ?>" class="btn btn-primary py-2 px-3">Denied</a></p>
		              </div>
		            </div>
		          </div>
    ...
    <footer class="ftco-footer ftco-section bg-light">
      <div class="container">
      	<div class="row">
      		<div class="mouse">
						<a href="../tmplate/#" class="mouse-icon">
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              ...
              <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
                <li class="ftco-animate"><a href="../tmplate/#"><span class="icon-twitter"></span></a></li>
                <li class="ftco-animate"><a href="../tmplate/#"><span class="icon-facebook"></span></a></li>
                <li class="ftco-animate"><a href="../tmplate/#"><span class="icon-instagram"></span></a></li>
              </ul>
            </div>
          </div>
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-5">
              ...
              <ul class="list-unstyled">
                <li><a href="../tmplate/#" class="py-2 d-block">Shop</a></li>
                <li><a href="../tmplate/#" class="py-2 d-block">About</a></li>
                <li><a href="../tmplate/#" class="py-2 d-block">Journal</a></li>
                <li><a href="../tmplate/#" class="py-2 d-block">Contact Us</a></li>
              </ul>
            </div>
          </div>
          <div class="col-md-4">
             <div class="ftco-footer-widget mb-4">
              ...
              <div class="d-flex">
	              <ul class="list-unstyled mr-l-5 pr-l-3 mr-4">
	                <li><a href="../tmplate/#" class="py-2 d-block">Shipping Information</a></li>
	                <li><a href="../tmplate/#" class="py-2 d-block">Returns &amp; Exchange</a></li>
	                <li><a href="../tmplate/#" class="py-2 d-block">Terms &amp; Conditions</a></li>
	                <li><a href="../tmplate/#" class="py-2 d-block">Privacy Policy</a></li>
	              </ul>
	              <ul class="list-unstyled">
	                <li><a href="../tmplate/#" class="py-2 d-block">FAQs</a></li>
	                <li><a href="../tmplate/#" class="py-2 d-block">Contact</a></li>
	              </ul>
	            </div>
            </div>
          </div>
            ...
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                ...
	                <li><a href="../tmplate/#"><span class="icon icon-phone"></span><span class="text">+2 392 3929 210</span></a></li>
	                <li><a href="../tmplate/#"><span class="icon icon-envelope"></span><span class="text">info@yourdomain.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p><!-- Link back to Trinity Technologies can't be removed. Template is licensed under CC BY 3.0. -->
						  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart color-danger" aria-hidden="true"></i> by <a href="../tmplate/https://Trinity Technologies.com" target="_blank">Trinity Technologies</a>
						  <!-- Link back to Trinity Technologies can't be removed. Template is licensed under CC BY 3.0. -->
						</p>
          </div>
        </div>
      </div>
