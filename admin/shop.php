          ...
          <div class="col-lg-12 ftco-animate">
						<div class="row">
                                                     ...
                                                     <?php
                                                        ...
                                                        $sel_gal=mysqli_query($dbcon,"select * from shop_reg where st='1'");
		            ...
		            <div class="blog-entry align-self-stretch d-md-flex">
		              <a href="../tmplate/blog-single.html" class="block-20" style="background-image: url('../img1/<?php echo $r_gal[9] ?>');width: 600px;height: 250px">
		              </a>
		              <div class="text d-block pl-md-4">
		                ...
		                <p><?php echo $r_gal[5] ?></p>
                                <p><a href="shop.php?del=<?php echo $r_gal[0] ?>" class="btn btn-primary py-2 px-3">Denied</a></p>
		              </div>
		            </div>
		          </div>
